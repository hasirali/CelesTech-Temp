  ...
  return (
   <>
    <div className='home' id='homee'>
        <main>
            <h1>CelecTech</h1>
            <p>This single solution addresses every issue</p>
        </main>
    </div>
    <div className="home2">
        <img src={vg} alt="graphocs" />
        <div >
            <p>We stand as your exclusive solution to the everyday tech challenges you encounter. As a pioneering tech entity, our objective is to enhance problem-solving skills among children.</p>
        </div>
    </div>
